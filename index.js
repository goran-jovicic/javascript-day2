...
createLetter = (letter) => 
    ...
    setTimeout(() => {
        ...
        if(letter.primaoc.firstName === letter.posiljalac.firstName && letter.primaoc.lastName === letter.posiljalac.lastName){
...
let pismo1 = new Letter(customer,customer,'Tekst pisma');
postOffice.createLetter(pismo1)
